...
var Validator = function (_React$Component) {
    ...
    _createClass(Validator, [{
        ...
        value: function componentDidUpdate(prevProps) {
            ...
            if (!(0, _lodash.isEqual)(this.props.reference, prevProps.reference)) {
                ...
                if (validationRules) {
                    var flag = true;
                    (0, _lodash.forEach)(validationRules, function (rule, func) {
                        if (flag) {
                            debugger;
                            var message = validationMessages[func];
                            if (_this2[func](rule, reference)) {
